<template>
  <section class="grid grid-cols-1 gap-4 md:grid-cols-3">
    <a :href="contact.url" class="rounded-lg shadow hover:shadow-md dark:shadow-md dark:hover:shadow-lg" rel="noreferrer noopener" v-for="(contact, i) in contacts" :key="i">
